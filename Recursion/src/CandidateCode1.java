...
public class CandidateCode1 {
	...
	int size;
	int memo[][];
	public CandidateCode1(int size, char[] pattern) {
		this.size = size;
	...
	public static void main(String[] args) {
		...
		CandidateCode1 mi = new CandidateCode1(Integer.parseInt(sc.next()), (sc.nextLine() + sc.nextLine()).toCharArray());
	...
	private static int findMinInsertion(CandidateCode1 mi, int i, int j) {
